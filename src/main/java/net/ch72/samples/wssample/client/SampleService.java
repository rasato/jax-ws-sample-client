 ...
 * 
 */
@WebServiceClient(name = "SampleService", targetNamespace = "http://wssample.samples.ch72.net/", wsdlLocation = "http://localhost:8080/wssample/SampleService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAMPLESERVICE_QNAME = new QName("http://wssample.samples.ch72.net/", "SampleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/wssample/SampleService?wsdl");
    ...
    public Sample getSamplePort() {
        return super.getPort(new QName("http://wssample.samples.ch72.net/", "SamplePort"), Sample.class);
    }
    ...
    public Sample getSamplePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wssample.samples.ch72.net/", "SamplePort"), Sample.class, features);
    }
